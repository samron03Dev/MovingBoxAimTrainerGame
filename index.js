let AimTrainerGame = {
    ...
    functions: {
        ...
        draw_game: function() {
            ...
            if(AimTrainerGame.data.posX + AimTrainerGame.data.ballRadius >= 1900 || AimTrainerGame.data.posX <= 0) {
                AimTrainerGame.data.ballVelocityX *= -1;
            }
            else if(AimTrainerGame.data.posY + AimTrainerGame.data.ballRadius >= 850 || AimTrainerGame.data.posY <= 0) {
